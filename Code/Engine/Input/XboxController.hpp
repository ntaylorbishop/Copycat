...
public:
	...
	bool IsConnected();
	int GetControllerID() { return m_controllerNumber; }
private:
	int m_controllerNumber;
	WORD m_buttons;
	WORD m_prevButtons;
	int m_button_frameNumber[14];
	Vector2 m_lThumb; //The actual stick position
	Vector2 m_rThumb; //The actual stick position
	PolarCoords m_lThumbPolar;
	PolarCoords m_rThumbPolar;
