...
//---------------------------------------------------------------------------
ApparatusAudioSystem::ApparatusAudioSystem()
...
//
void ApparatusAudioSystem::InitializeFMOD()
{
...
//---------------------------------------------------------------------------
SoundID ApparatusAudioSystem::CreateOrGetSound(const std::string& soundFileName)
{
...
//---------------------------------------------------------------------------
AudioChannelHandle ApparatusAudioSystem::Play(SoundID soundID, float volumeLevel)
{
...
AudioChannelHandle ApparatusAudioSystem::PlayLoop(SoundID soundID, float volumeLevel)
{
	unsigned int numSounds = m_registeredSounds.size();
	if (soundID < 0 || soundID >= numSounds)
		return nullptr;
...
void ApparatusAudioSystem::StopChannel(AudioChannelHandle channel)
{
	if (channel != nullptr)
	{
...
void ApparatusAudioSystem::PauseChannel(AudioChannelHandle channel) {
	if (channel != nullptr)
	{
		FMOD::Channel* fmodChannel = (FMOD::Channel*) channel;
...
void ApparatusAudioSystem::UnpauseChannel(AudioChannelHandle channel) {
	if (channel != nullptr)
	{
		FMOD::Channel* fmodChannel = (FMOD::Channel*) channel;
...
void ApparatusAudioSystem::ChangeVolumeOfChannel(AudioChannelHandle channel, float volume) {
	if (channel != nullptr) {
		FMOD::Channel* fmodChannel = (FMOD::Channel*) channel;
...
//---------------------------------------------------------------------------
void ApparatusAudioSystem::Update(float deltaSeconds)
{
	deltaSeconds;
...
//---------------------------------------------------------------------------
void ApparatusAudioSystem::ValidateResult(FMOD_RESULT result)
{
	if (result != FMOD_OK)
	{
