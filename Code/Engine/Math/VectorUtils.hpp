...
inline float Dot(const IntVector2& v1,	const IntVector2& v2)	{ return DotProduct(v1, v2); }
inline float Dot(const Vector2& v1,		const Vector2& v2)		{ return DotProduct(v1, v2); }
inline float Dot(const IntVector3& v1,	const IntVector3& v2)	{ return DotProduct(v1, v2); }
inline float Dot(const Vector3& v1,		const Vector3& v2)		{ return DotProduct(v1, v2); }
inline float Dot(const Vector4& v1,		const Vector4& v2)		{ return DotProduct(v1, v2); }
