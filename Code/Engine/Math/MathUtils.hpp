...
const float PI_HALF_F		= 1.57079632679489661923f;
...
//---------------------------------------------------------------------------------------------------------------------------
inline float RollBase(float min, float max) {
	return Randf(min, max);
}
inline int RollBase(int min, int max) {
	return RandInt(min, max);
}
inline IntVector2 RollBase(const IntVector2& min, const IntVector2& max) {
	return IntVector2(RandInt(min.x, max.x), RandInt(min.y, max.y));
}
inline Vector2 RollBase(const Vector2& min, const Vector2& max) {
	return Vector2(Randf(min.x, max.x), Randf(min.y, max.y));
}
inline IntVector3 RollBase(const IntVector3& min, const IntVector3& max) {
	return IntVector3(RandInt(min.x, max.x), RandInt(min.y, max.y), RandInt(min.z, max.z));
}
inline Vector3 RollBase(const Vector3& min, const Vector3& max) {
	return Vector3(Randf(min.x, max.x), Randf(min.y, max.y), Randf(min.z, max.z));
}
...
IntVector2	Lerp(const IntVector2& startVector, const IntVector2& endVector, float t);
...
//---------------------------------------------------------------------------------------------------------------------------
inline float RangeMapFloat(const float inputValue, const float inputRangeStart, const float inputRangeEnd, 
	const float outputRangeStart, const float outputRangeEnd) {
